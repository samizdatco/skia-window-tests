...
impl RendererBuilder {
    ...
    pub fn new() -> Self {
        RendererBuilder {
            ...
            validation_layer_debug_report_flags: vk::DebugUtilsMessageSeverityFlagsEXT::default(),
    ...
    pub fn use_vulkan_debug_layer(
        ...
        self.validation_layer_debug_report_flags(if use_vulkan_debug_layer {
            ...
            vk::DebugUtilsMessageSeverityFlagsEXT::default()
        })
    }
...
impl Renderer {
    ...
    pub fn skia_context(&self) -> &skia_safe::gpu::DirectContext {
    ...
    fn do_draw<F: FnOnce(&mut skia_safe::Canvas, CoordinateSystemHelper)>(
...

        {
            ...
            self.skia_context.context.flush(None);
        }
