...
struct FixedFunctionState<'a> {
    vertex_input_assembly_state_info: vk::PipelineInputAssemblyStateCreateInfo<'a>,
    vertex_input_state_info: vk::PipelineVertexInputStateCreateInfo<'a>,
    viewport_state_info: vk::PipelineViewportStateCreateInfo<'a>,
    rasterization_info: vk::PipelineRasterizationStateCreateInfo<'a>,
    multisample_state_info: vk::PipelineMultisampleStateCreateInfo<'a>,
    color_blend_state_info: vk::PipelineColorBlendStateCreateInfo<'a>,
    dynamic_state_info: vk::PipelineDynamicStateCreateInfo<'a>,
}
...
impl VkSkiaRenderPass {
    ...
    >(
        ...
        let renderpass_attachments = [vk::AttachmentDescription::default()
